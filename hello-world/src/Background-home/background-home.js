...
class Home extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Header grade={{...this.state.data.grade,...this.state.data.period}} courseList={this.state.data.courseList}/>
                <div id="box">
                    ...
                    <LeftSide students={this.state.data.students} changeIndex={this.changeIndex} clickedStudent={this.state.index}/>
                </div>
                <Mask flag={this.state.flag} cancelMask={this.cancelMask}  reward={this.state.data.rewards[this.state.num]} changeScore={this.changeScore}/>
            </div>

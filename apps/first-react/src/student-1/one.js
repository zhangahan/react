...
import RightToptitle from './rightToptitle.js';
import Delprogram from './delProgram.js';
import Mask from './mask.js';
import add from './tianjia.png';
import del from './classjian.png';
import App from '../App.js';
import setNotClick from './setNotClick.png';
...
var str1 = {
    ...
    "teacherList": [{"tid": 7, "tname": "苗林超", "type": "1", "officeType": "1"},
        {"tid": 8, "tname": "胡乃全", "type": "2", "officeType": "1"},
        {"tid": 9, "tname": "梁静", "type": "2", "officeType": "1"},
        {"tid": 10, "tname": "孙绍瑜", "type": "1", "officeType": "1"},
        {"tid": 11, "tname": "施丽芳", "type": "1", "officeType": "1"},
        {"tid": 12, "tname": "李欢欢", "type": "2", "officeType": "1"},
        {"tid": 13, "tname": "腾琴琴", "type": "1", "officeType": "1"},
        {"tid": 14, "tname": "陈梦", "type": "2", "officeType": "1"},
        {"tid": 15, "tname": "杨小艳", "type": "2", "officeType": "1"},
        {"tid": 16, "tname": "张俊杰", "type": "1", "officeType": "1"},
        {"tid": 17, "tname": "刘旭东", "type": "1", "officeType": "1"},
        {"tid": 18, "tname": "赵子文", "type": "1", "officeType": "1"}],
    "status": 200,
    "rewards": [{"id": 3, "name": "打扫卫生", "type": "1", "des": "", "score": 5},
        ...
        {"id": 22, "name": "111", "type": "1", "des": null, "score": 100},
        {"id": 23, "name": "111", "type": "1", "des": null, "score": 100},
        {"id": 24, "name": "12", "type": "1", "des": null, "score": 22},
        {"id": 25, "name": "12322", "type": "1", "des": null, "score": 123},
        {"id": 26, "name": "44", "type": "1", "des": null, "score": 66},
        {"id": 27, "name": "44", "type": "2", "des": null, "score": -55},
        {"id": 28, "name": "4", "type": "2", "des": null, "score": -5}],
    "courseList": [{"id": 7, "cname": "PS & AI图标与界面设计软件", "tname": null, "type": "1", "score": null},
        ...
        {"id": 32, "cname": "面向对象编程技术，配置工具使用服务器配置调优，数据库建模", "tname": null, "type": "1", "score": null},
...
class One extends Component {
    ...
    /*componentDidMount(){
     var fea = fetch("http://192.168.60.100:8080/cms/login/login.do?roleName=admin&password=root&roleType=1&officeType=1");
     console.log(fea.then(response=>response.json()).then(json=>json()));
     }*/
    render() {
        return (
            <div style={this.props.nameBlock1===1?{display:"block"}:{display:"none"}}>
                <Header teacher={str1.grade} date={str1.period} img={setNotClick} fnB={()=>this.props.fn(0)}/>

                <div id="box">
                    <div className="box-side-left">
                        <LeftTop date={str1.period} teacher={str1.grade}/>
                        <LeftBottom name={str1.students} fn={this.changeState}/>
                    </div>
                    <div className="box_body">
                        <RightTop name={str1.students} data={this.state.data.students[this.state.flag]}/>
                        <RightToptitle title={"奖励加薪项目"} img={add} color={"#544B14"} bg={"#EFD63B"}/>
                        <Program name={arr1} fn={this.changData}/>
                        <RightToptitle title={"惩罚减薪项目"} img={del}/>
                        <Delprogram name={arr2} fn={this.changData} namea={arr1.length}/>
                        <Mask name={this.state.num} changeBoxR={this.changData}
                              names={arr3[this.state.num==-1?0:this.state.num]} nameNum={arr1.length-1}
                              data={this.state.data.students[this.state.flag]} fn={this.changeDataState}/>

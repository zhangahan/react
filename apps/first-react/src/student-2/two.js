...
import Header from '../student-1/header.js';
import remove from '../student-1/administrator.png';
import LeftTop from '../student-1/leftTop.js';
import degree from '../student-1/ban_03.png';
import RightToptitle from '../student-1/rightToptitle.js';
import TwoRight from './two-ul.js';
...
var str1 = {
    ...
    "students": [{
        ...
        },
        {
            ...
            "m602651625+62++5+561561+91arket": "鲁东市场部",
            "pic": null,
            "beginsDate": "8",
            "term": "一年",
            "birthday": "6"
...
class Two extends Component {
    ...
    render() {
        return (
            <div style={this.props.nameBlock1===0?{display:"block"}:{display:"none"}}>
                <Header teacher={str1.grade} date={str1.period} img={remove} fnB={()=>this.props.fn(1)}/>

                <div className="box">
                    <div className="box-side-left">
                        <LeftTop date={str1.period} teacher={str1.grade}/>
                        <ul className="box_left_bottom">
                            <li className="selected">学生管理</li>
                        </ul>
                    </div>
                    <div className="box_right">
                        <RightToptitle title={"学生管理"} img={degree} color={"#544B14"} bg={"#EFD63B"}/>
                        <TwoRight names={str1.students}/>
                    </div>

...
import { Router, Route, hashHistory ,IndexRoute ,IndexRedirect , Link,Redirect} from 'react-router';
 ...
 class BonusItem extends Component {
    ...
    render() {
        ...
        return (
            <li
                style={this.props.numColor==this.props.rewards.id?{backgroundColor:colors[this.props.index%5],boxShadow:"0 0 10px"+colors[this.props.index%5]}:{borderBottom:"1px solid"+colors[this.props.index%5]}}
